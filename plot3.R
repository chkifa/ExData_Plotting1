...
plot(HH_power_P1_Date,HH_power_P1$Sub_metering_1, type="l",xlab="",ylab="Energy sub metering")
lines(HH_power_P1_Date,HH_power_P1$Sub_metering_2, col="red",type="l")
lines(HH_power_P1_Date,HH_power_P1$Sub_metering_3, col="blue",type="l")
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       pch="__",col=c("black", "red", "blue"), bty="l")
